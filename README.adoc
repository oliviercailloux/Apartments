...
* Update the `GetStartedWithTheProject` documentation according to the professor given in the link:https://github.com/oliviercailloux-org/projet-apartments/pull/44[PR#44].
...
* Add the statistics on `LayoutApartmentGUI` by creating a grid that will display the statistics about the apartments. (*Prerequisite : It's necessary to do the first and second task to did this*)
