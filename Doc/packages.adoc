...
.see Selection profile screen
[%collapsible]
====
image::gui-select-profile.png?raw=true[Selection profile screen]
====
...
.see Profile selection question
[%collapsible]
====
image::gui-questions.png?raw=true[Profile selection question]
====
...
.see AskOpinionForUtility questions
[%collapsible]
====
image::gui-askopinionforutility.png?raw=true[AskOpinionForUtility questions]
====
...
.see An example of filtered results display
[%collapsible]
====
image::gui-layoutapartment.png?raw=true[An example of filtered results]
====
...
image::diagram-sequence-interaction-user-application.svg?raw=true[sequence diagram : Interaction between user and application]
...
Currently, only this question is implemented (in `QuestionPriceArea`) +
